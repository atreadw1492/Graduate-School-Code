...
The scripts read in data from three different csv files ( train and test set for the Salary Analysis script and a dataset for the Workout Analysis script).
...
2) Workout Analysis
					...
					Implements the machine learning algorithms on workout-related data.  The goals of this script and analysis
					is to predict whether an individual is performing a specific workout correctly based off various factors.  
