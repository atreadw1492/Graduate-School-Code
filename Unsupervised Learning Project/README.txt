...
The code consists of two R scripts:		

Income Analysis -- Unsupervised.R
Exercise -- Unsupervised.R
										
The scripts read in data from three different csv files (a data for the Salary Analysis script and a dataset for the 
Workout Analysis script).

It is assumed that the scripts are being run from inside the directory containing these csv files.

1) Income Analysis

Implements the machine learning algorithms on salary-related data.  The goal of this script and analysis is to use 
unsupervised learning algorithms to analyze the attributes and structure of income-related data associated 
